...
![First Experiment](/media/Screenshot-2023-12-16-142939-914x1024.png)
*first experiment*

![Output Images in Directory](/media/capturemoon-1024x1011.png)
*output images in directory*

![Early Results](/media/generates-moons-in-place-1024x864.png)
*early results*
...
![Monitoring a Directory for the Latest Image](/media/function-latest-image-1024x689.png)
...
![Basic Workflow](/media/basic-workflow-1024x727.png)
...
![Perfecting the Prompt](/media/perfectingtheprompt-1024x852.png)
