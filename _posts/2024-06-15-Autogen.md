...
This is a demonstration of an [Autogen Studio 2.0](https://autogen-studio.com/autogen-studio-ui) workflow with three agents: Two comedians (Mark-Normand) and (Sam Morril), overseen by one Joke-Director.
